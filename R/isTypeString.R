...
#'
#' @description
#' `TRUE` iff the type string is a certain type,
#' e.g. `isIntegerTypeString` checks if we have \dQuote{integer} or \dQuote{integervector},
#' and `isVectorTypeString` check if we have \dQuote{*vector}.
#'
