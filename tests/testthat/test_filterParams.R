...
test_that("filter empty paramset", {
  ps = makeParamSet()
  expect_output(print(filterParams(ps, type = "numeric")), "Empty parameter set.")
  expect_output(print(filterParams(ps, type = "integer")), "Empty parameter set.")
  expect_output(print(filterParams(ps, type = "numericvector")), "Empty parameter set.")
  expect_output(print(filterParams(ps, type = "integervector")), "Empty parameter set.")
  expect_output(print(filterParams(ps, type = "discrete")), "Empty parameter set.")
  expect_output(print(filterParams(ps, type = "discretevector")), "Empty parameter set.")
  expect_output(print(filterParams(ps, type = "logical")), "Empty parameter set.")
  expect_output(print(filterParams(ps, type = "logicalvector")), "Empty parameter set.")
  expect_output(print(filterParams(ps, type = "character")), "Empty parameter set.")
  expect_output(print(filterParams(ps, type = "character")), "Empty parameter set.")
  expect_output(print(filterParams(ps, type = "function")), "Empty parameter set.")
  expect_output(print(filterParams(ps, type = "untyped")), "Empty parameter set.")
})
...
test_that("filtering of ids", {
  ...
  expect_output(print(filterParams(ps, type = "logical", ids = c("u", "v"))), "Empty parameter set.")
})
