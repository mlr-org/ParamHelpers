...
test_that("paramValueToString ", {
  ...
  x = makeLogicalParam("x", default = expression(a + b))
  ...
  expect_equal(paramValueToString(u, expression(4 + 5)), "expression")
  ...
  expect_equal(paramValueToString(x, x$default), "expression")
